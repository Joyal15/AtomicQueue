...
export interface CreateBusinessInput {
  /**
   * The Business document's pre-generated `_id`.
   *
   * Auth generates this before the owner-signup transaction opens so the
   * owner `User` can reference the same value through `User.businessId`.
   */
  id: string;
